...
class PengeluaranModel extends Render_Model
{


	public function getAllData($show=null, $start=null, $cari=null, $status=null, $id_cabang=null)
	{
		$exe 						= $this->db->select('*, b.kode as cabang_kode, b.nama as cabang_nama, d.nama as rab_nama, a.status');
					   $this->db->from('saldo_pengeluarans a');
	...
	{
		$exe 						= $this->db->get_where('saldo_pengeluarans', ['id' => $id]);
