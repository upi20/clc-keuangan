$(() => {
	...
	$('#harga_ringgit').on('change', function () {
		$.ajax({
			...
			$("#val_harga_ringgit").val(this.value)
			let harga_ringgit = this.value

			$("#harga_ringgit").val('RM ' + format_ringgit(this.value))
			$("#harga_rupiah").val('Rp ' + format_rupiah(data.rupiah))

			$("#val_harga_ringgit").val(this.value)
			$("#val_harga_rupiah").val(data.rupiah)

			$("#total_harga_ringgit").val('RM ' + format_ringgit(this.value))
	...
	$('#jumlah_1').on('change', function () {
		...
		var total_harga_ringgit = $("#val_total_harga_ringgit").val()
		var total_harga_rupiah = $("#val_total_harga_rupiah").val()
		var jumlah = parseInt(jumlah_1)

		total_harga_ringgit = parseInt(total_harga_ringgit) * parseInt(jumlah)
		total_harga_rupiah = parseInt(total_harga_rupiah) * parseInt(jumlah)

		$("#total_harga_ringgit").val('RM ' + format_ringgit(total_harga_ringgit))
		$("#total_harga_rupiah").val('Rp ' + format_rupiah(total_harga_rupiah))

		$("#val_total_harga_ringgit").val(total_harga_ringgit)
		$("#val_total_harga_rupiah").val(total_harga_rupiah)
	})
