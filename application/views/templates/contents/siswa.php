					...
					<div>
						...
						<div class="widget-body">
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
									<tr>
										<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> NIS</th>
										...
										<th data-hide="phone"><i class="fa fa-fw fa-check text-muted hidden-md hidden-sm hidden-xs"></i> Rombel</th>
										<th data-hide="phone"><i class="fa fa-fw fa-check text-muted hidden-md hidden-sm hidden-xs"></i> Grup</th>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="rombel" placeholder="Rombel" required />
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
								<label for="nama"> Grup</label>
								<input type="text" class="form-control" id="grup" placeholder="Grup" required />
							</div>
						</div>
					</div>
...
<div class="modal fade" id="myModal-import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<form action="<?= base_url() ?>siswa/importExcel" method="post" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
						&times;
