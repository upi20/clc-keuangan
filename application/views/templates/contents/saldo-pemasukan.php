	...
	<!-- row -->
		...
		<!-- col -->
			...
			<div class="pull-right">
				<div class="col-xs-12 col-sm-7 col-md-7 col-lg-22">
					...
					<div>
						...
						<div class="widget-body">
							...
							<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>
									<tr>
										<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Nama Pengguna</th>
										<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Kode Cabang</th>
