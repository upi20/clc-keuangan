...
<body class="desktop-detected pace-done smart-style-<?= $template_type ?> <?= $page_setting ?>">
	...
	<!-- #HEADER -->
	<header id="header" style="background-color: #181818;">
		<div id="logo-group">
			<!-- PLACE YOUR LOGO HERE -->
			<span id="logo"> <img style="width:145px" src="<?= base_url() ?>assets/img/j-logo.png" alt="SmartAdmin"> </span>
	...
	<!-- PAGE FOOTER -->
	<div class="page-footer" style="background-color: #181818;">
		<div class="row">
